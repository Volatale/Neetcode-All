...
//* Use an array of "k" space instead of "n" space
//* We only need the "k" previous results according to the recurrence relation
...
//* Space: O(k) - We create an array of size "k", so the space usage scales with "k"
//* We only need the "k" previous results
