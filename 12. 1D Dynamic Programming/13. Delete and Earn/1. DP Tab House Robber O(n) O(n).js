...
function deleteAndEarn(nums) {
  ...
  //* dp[i] = Max value we can get at index i considering first "i" elements
...
//* It takes O(n) to create the dp and points array
//* Then it takes O(n) to compute every subproblem

//* Space: O(n) - The DP array and buckets array use O(n) space
