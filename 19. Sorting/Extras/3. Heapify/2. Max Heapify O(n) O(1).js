...
const isGreater = (nums, a, b) => nums[a] > nums[b];

console.log(heapify([7, 7, 9, 2, 15, 10, 5, 12], isGreater)); //* [15, 12, 10, 7, 7, 9, 5, 2]
console.log(heapify([1, 2, 3], isGreater)); //* [3, 2, 1]
console.log(heapify([1], isGreater)); //* [3, 2, 1]
