...
function evaluate(curr, map) {
  switch (curr.val) {
    ...
    case 1:
      ...
      break;
    case 2:
      map.set(curr, map.get(curr.left) || map.get(curr.right)); //* OR
      break;
    case 3:
      map.set(curr, map.get(curr.left) && map.get(curr.right)); //* AND
      break;
  }
}
...
//* The space used by the map scales with the number of nodes
