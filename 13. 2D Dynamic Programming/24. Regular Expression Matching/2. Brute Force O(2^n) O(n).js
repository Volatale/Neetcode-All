...
//* Time: O(2^n) - Each call leads to 2 more calls in the worst case
//* The height of the recursion tree scales with the length of "s"

//* Space: O(n) - The height of the recursion tree scales with "s"
